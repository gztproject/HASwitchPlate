...
public:
    ...
    static unsigned int retryMax;             // Attempt to connect to panel this many times
    static const unsigned long checkInterval; // Time in msec between nextion connection checks
...
private:
    ...
    static unsigned long checkTimer;          // Timer for nextion connection checks
};
